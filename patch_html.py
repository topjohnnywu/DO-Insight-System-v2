...
# 1. Add "View Final Plan" button
button_html = """                        <button onclick="showFinalPlan()" class="action-btn" style="background: var(--surface-hover); color: var(--fg); border: 1px solid var(--border); padding: 8px 16px; border-radius: var(--radius-control); display: inline-flex; align-items: center; gap: 6px;">
...
"""
content = content.replace('                        <button onclick="exportTruckPlan()"', button_html + '                        <button onclick="exportTruckPlan()"')

# 2. Add Modal overlay at the end of the file before </body> or script tags
modal_html = """
    <!-- Final Plan Modal -->
...
content = content.replace('    <script src="js/app.js"></script>', modal_html + '\n    <script src="js/app.js"></script>')
