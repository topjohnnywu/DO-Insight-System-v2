...
new_function = """function exportTruckPlan() {
    ...
    Object.keys(trucks).forEach((tId, index) => {
        ...
        for (const cName in consigneeGroups) {
            ...
            // Based on second screenshot, they do NOT group DOs into a comma string anymore,
            // they list them out individually.
            // (HUB)
            // 812838
            // 3.13m3
            // (HUB)
            ...
            dos.forEach(d => {
                ...
                wsData.push([
                    { v: String(d.inv), t: 's', s: styleDoNum }
                ]);
                wsData.push([
            ...
            // NO SPACE BETWEEN CONSIGNEES OR TRUCKS IN THE NEW SCREENSHOT!
            // It looks tightly packed.
        }
        truckIdx++;
    });
